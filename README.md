...
| 选项 | 说明 |
|------|------|
| 默认写回 | 按 `chromeId` 更新标题、URL、位置与层级 |
| **删除插件中已移除的书签** | 同步删除浏览器中对应条目（不可恢复，请谨慎勾选） |

### ⚠️ 使用注意

- 带 **🔒** 的节点为 Chrome **系统根目录**（书签栏、其他书签等），**不可改名、删除或拖拽**，请只整理其**内部**子项。
...
- **应用回浏览器** 并勾选删除选项可能导致书签永久丢失，请自行备份重要数据。
